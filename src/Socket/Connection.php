...
use App\Socket\Stream\DuplexResourceStream;
use App\Socket\Stream\WritableResourceStream;
...
class Connection extends EventEmitter implements ConnectionInterface
{
     ...
     */
    public function setAsyncWrite(bool $asyncWrite): ConnectionInterface
    {
